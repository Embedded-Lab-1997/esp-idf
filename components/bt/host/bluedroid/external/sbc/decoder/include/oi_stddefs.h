...
// Budo  commented because I need BIT1 for station_example_main.c #define BIT1   0x00000002  /**< preprocessor alias for 32-bit value with bit 1 set, used to specify this single bit */
